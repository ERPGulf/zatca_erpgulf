...
def reporting_api_xml_sales_invoice_simplifeid(
    ...
    try:
        ...
        frappe.throw(
            f"Error in reporting API-1 sales invoice with xmlin simplifed: {str(e)}"
        )
...
def submit_sales_invoice_simplifeid(sales_invoice_doc, file_path, invoice_number):
    ...
    try:
        ...
        reporting_api_xml_sales_invoice_simplifeid(
            uuid1,
            encoded_hash,
