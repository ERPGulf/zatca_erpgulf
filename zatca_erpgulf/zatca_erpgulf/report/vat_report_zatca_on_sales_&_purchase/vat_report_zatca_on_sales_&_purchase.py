...
#             totals["OtherExpense"] = get_other_expense_tax(filters)
#     return totals
...
#     query = f"""
#         SELECT
#             SUM(gle.credit - gle.debit) AS vat_amount
...
#         WHERE {where_clause}
#             AND acc.account_type = 'Tax'
#             AND IFNULL(acc.custom_zatca_account_type, '') != ''
#             AND gle.voucher_type NOT IN (
#                 'Sales Invoice',
#                 'Purchase Invoice'
#             )
#     """
...
#     query = f"""
#         SELECT
#             SUM(gle.debit - gle.credit) AS vat_amount
